...
func TestAESEncryptDecrypt(t *testing.T) {
	...
	expcs := [][]byte{
		{0x47, 0xa8, 0xe6, 0xf1, 0xb5, 0xa8, 0x1a, 0x37, 0x02, 0xd0, 0x30, 0x3a, 0x88, 0x47, 0x36, 0xc9, 0x76, 0x5b, 0x98, 0x0f, 0xbd, 0xd9, 0x6f, 0x9b, 0x03, 0x5a, 0x03, 0x09, 0x81, 0x8c, 0xeb, 0x4b},
		{0xa0, 0xbf, 0xdb, 0x4c, 0x5d, 0x71, 0x78, 0xe0, 0xef, 0xb7, 0x8b, 0x85, 0xb6, 0x20, 0x0e, 0x78, 0xcf, 0x01, 0x37, 0xbe, 0xb4, 0x04, 0x1e, 0xcb, 0xcf, 0x16, 0x10, 0x4e, 0x32, 0x3c, 0x15, 0xd5},
		{0x6f, 0x53, 0x67, 0xfc, 0x68, 0x72, 0xdf, 0x67, 0x3d, 0xaf, 0xc2, 0xcf, 0xce, 0xe9, 0x13, 0xf0, 0x72, 0x3d, 0xb6, 0x6f, 0x86, 0x3e, 0x5a, 0xee, 0xc7, 0x47, 0xea, 0x3c, 0xbf, 0x1a, 0x87, 0xc2},
		{0xd9, 0x56, 0xeb, 0x62, 0x74, 0x13, 0xe3, 0xf3, 0xe4, 0x75, 0xe4, 0x38, 0xb1, 0x7d, 0xdf, 0x47, 0x76, 0x5b, 0x98, 0x0f, 0xbd, 0xd9, 0x6f, 0x9b, 0x03, 0x5a, 0x03, 0x09, 0x81, 0x8c, 0xeb, 0x4b},
		{0x53, 0x0c, 0xd9, 0x2f, 0xa7, 0x7b, 0x77, 0xe9, 0x84, 0x7d, 0x55, 0xc3, 0x9d, 0xec, 0xd4, 0xf3, 0x29, 0x46, 0x12, 0xd2, 0xc8, 0x1f, 0x0f, 0x7e, 0x6a, 0x63, 0x99, 0x76, 0xdf, 0xa3, 0x70, 0x76},
		{0x06, 0x40, 0xef, 0xe6, 0x0f, 0x34, 0x07, 0x89, 0xb1, 0x47, 0x3a, 0x37, 0xc1, 0xa8, 0xc5, 0xa2, 0x5b, 0x8c, 0x7a, 0x34, 0x3e, 0x7f, 0xdb, 0x78, 0xa2, 0x1a, 0xbc, 0x8f, 0xc2, 0x03, 0xf7, 0xc0},
		{0x77, 0xd1, 0x13, 0x17, 0xab, 0x42, 0x0d, 0x27, 0xc9, 0xb4, 0x76, 0x42, 0x5d, 0x3c, 0x5d, 0x95, 0x95, 0x4f, 0x64, 0xf2, 0xe4, 0xe8, 0x6e, 0x9e, 0xee, 0x82, 0xd2, 0x02, 0x16, 0x68, 0x48, 0x99},
	}
	...
	for i := 0; i < len(expcs); i++ {
		...
		if !util.IsBytestringEqual(result, expcs[i]) {
			t.Fatalf(`TestAESEncryptDecrypt: AESEncrypt(tests_bytestr[%d], tests_key[%d]) != expcs[%d]`, i, i, i)
		}
		...
		if !util.IsBytestringEqual(tests_bytestr[i], decrypted) {
			t.Fatalf(`TestAesEncryptDecrypt: AESDecrypt(result[%d], tests_key[%d]) != tests_bytestr[%d]`, i, i, i)
		}
	}
}
